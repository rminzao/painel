<form>
    <div class="form fv-plugins-bootstrap5 fv-plugins-framework">
        ...
        <input type="hidden" name="CondictionID">
        <div class="row">
            <div class="d-flex flex-column mb-5 fv-row col-12">
                ...
                <input type="text" class="form-control form-control-sm form-control-solid" placeholder=""
                    step="1" name="CondictionTitle" />
            </div>
            <div class="d-flex flex-column mb-5 fv-row col-12">
                <label class="form-label">💾 Tipo</label>
                <select class="form-select form-select-sm form-select-solid" data-control="select2"
                    name="CondictionType" data-dropdown-parent="#md_condition_update" placeholder="Selecione o tipo">
        ...
        <div class="row">
            <div class="mb-5 fv-row col-6">
                ...
                <input type="number" class="form-control form-control-sm form-control-solid" placeholder=""
                    step="1" name="Para1" value="" />
            </div>
            <div class="mb-5 fv-row col-6">
                <label class="form-label" id="para2">❓ Para2</label>
                <input type="number" class="form-control form-control-sm form-control-solid" placeholder=""
                    step="1" name="Para2" value="" />
            </div>
        </div>
        <div class="d-flex flex-stack mb-5">
            ...
            <label class="form-check form-switch form-check-custom form-check-solid">
                <input class="form-check-input h-20px w-30px" type="checkbox" name="isOpitional" value="1" />
                <span class="form-check-label fw-bold text-muted"></span>
            </label>
        </div>
        <div class="text-center">
            <button type="button" onclick="condition.update()" id="btn_condition_update"
