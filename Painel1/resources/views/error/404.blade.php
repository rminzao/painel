...
<body id="kt_body" class="dark-mode auth-bg">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-column flex-center flex-column-fluid p-10">
            <!--begin::Illustration-->
            <img src="{{ url() }}/assets/media/illustrations/sigma-1/18-dark.png" alt=""
                class="mw-100 mb-10 h-lg-450px" />
            <!--end::Illustration-->
            <!--begin::Message-->
            <h1 class="fw-bold mb-10" style="color: #A3A3C7">Nada por aqui</h1>
            <!--end::Message-->
            <!--begin::Link-->
            <a href="{{ url() }}" class="btn btn-primary">Voltar a página inicial</a>
            <!--end::Link-->
        </div>
